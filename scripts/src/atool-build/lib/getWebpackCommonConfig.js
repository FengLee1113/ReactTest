...
export default function getWebpackCommonConfig(args) {
  ...
  const templatePath = join(args.cwd, pkg.template);    
      ...
      new webpack.optimize.CommonsChunkPlugin({
        ...
        minChunks: function (module, count) {
          return module.resource &&
            (module.resource.indexOf('uisf-react') !== -1
            || module.resource.indexOf('uisf-mobile') !== -1
            || module.resource.indexOf('uisf-ionic') !== -1
